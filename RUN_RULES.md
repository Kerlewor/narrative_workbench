...
| Writer 前 | 无强制脚本；必须读取 intent / plan / hook_protocol | `chapter-000N.writer.md` handoff |
| Polish 前 | 无强制脚本；必须读取 style_profile / style_guide | `chapter-000N.polish.md` handoff |
| Review 前 | 若已有候选正文文件，运行 `python3 scripts/text_audit.py <候选正文路径>` | `chapter-000N.review.md` |
| Final-check 前 | `python3 scripts/text_audit.py chapters/000N_标题.md` 或候选稿路径、`python3 scripts/hook_report.py --current N`、`python3 scripts/hook_matrix.py --current N` | `chapter-000N.final-check.md` |
